...
/**
 * Specifies whether editing is prohibited. The default value is false.
 */
mxGraph.prototype.noEditing = false;
...
//------------------------------ Custom modification content 003 start ------------------------------
    //禁止编辑
		if (mxGraph.prototype.noEditing)
		{
			style[mxConstants.STYLE_EDITABLE] = 0;   // 可编辑
			style[mxConstants.STYLE_MOVABLE] = 0;   // 定义可移动样式的键
			style[mxConstants.STYLE_BENDABLE] = 0;  // 定义可弯曲样式的关键点。
			style[mxConstants.STYLE_ROTATABLE] = 0; // 定义可旋转样式的键。
			style[mxConstants.STYLE_RESIZABLE] = 0; // 定义可调整大小样式的键。
			style[mxConstants.STYLE_DELETABLE] = 0; // 可删除
		}
