...
Format.noEditing = function(flag)
{
    mxGraph.prototype.noEditing = flag
    EditorUi.prototype.noEditing = flag;
    Format.hideSidebar(flag, flag);
};
Format.hideSidebar = function(left, right)
{
    EditorUi.prototype.hideLeft = left;
    EditorUi.prototype.hideRight = right;
    if (EditorUi.prototype.hideRight) {
