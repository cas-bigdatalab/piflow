...
def expand(source, scenarios):
    ...
    add("air_temperature", "TA_Avg", "气温", "degC", ["温度", "空气温度", "temperature"], auxiliary=weather[1:])
    ...
    add("wind_direction_unwrapped", "WD_Unwrapped", "风向（连续角度）", "degree", ["风向", "风向角", "wind_direction", "WD_Avg"],
    ...
    for probe in (1, 2, 3):
        ...
        add(temperature, f"TS{probe}_Avg", f"第{probe}组温度观测", "degC", ["土壤温度", "地温", "soil_temperature"],
