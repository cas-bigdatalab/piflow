...
class DataspaceFileSourceStop(ConfigurableStop):
    ...
    def set_properties(self, properties: dict[str, Any]) -> None:
        ...
        if not isinstance(raw_input_file_path, str):
            raise TypeError("dataspace file source property 'input_file_path' must be a string")
        self.input_file_path = raw_input_file_path.strip()
        if not self.input_file_path:
            raise ValueError("dataspace file source property 'input_file_path' must not be empty")
