...
class OpenGaussWrite extends ConfigurableStop {

  val authorEmail: String = "3175989593@qq.com"
  val description: String = "Write data into openGauss database with jdbc driver"
  ...
  def perform(in: JobInputStream, out: JobOutputStream, pec: JobContext): Unit = {
    ...
    properties.put("driver", "org.postgresql.Driver") // openGauss can also use the postgresql driver
  ...
  override def getPropertyDescriptor(): List[PropertyDescriptor] = {
    ...
    val url=new PropertyDescriptor()
      ...
      .defaultValue("jdbc:postgresql://...:5432/postgres")
      .required(true)
  ...
  override def getIcon(): Array[Byte] = {
    ImageUtil.getImage("icon/jdbc/openGaussWrite.png")
  }
