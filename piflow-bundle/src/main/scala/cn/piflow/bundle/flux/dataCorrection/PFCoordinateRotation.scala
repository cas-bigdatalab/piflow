...
class PFCoordinateRotation extends ConfigurableStop{
  val authorEmail: String = "ygang@cnic.cn"
  val description: String = "Plane fitting rotation(PF)"
  ...
  override def perform(in: JobInputStream, out: JobOutputStream, pec: JobContext): Unit = {
    ...
    val df = fluxDataCorrection.PFCoordinateRotationUtil(spark,originDF
      ,Fc
      ,Le
      ,Hs
      ,u_star
