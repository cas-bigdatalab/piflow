...
class UrlTest {
  val url : Map[String, String] = Map("url" -> "http://10.0.86.98:8002/flow/info?appID=application_1539588927382_0011")

  @Test
  def testGetHttp(): Unit = {

    //    val getHttp = new GetUrl
    //    getHttp.setProperties(url)
    //    val postUrl = new PostUrl
    //    val flow = new FlowImpl()
    //    flow.addStop("url",postUrl)
