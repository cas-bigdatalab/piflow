...
def _seed_builtin_s3_type(cursor) -> None:
    init_fields = [
        {
            "name": "name",
            "label": "数据源名称",
            ...
            "secret": False,
            "options": [],
            "description": "用于区分不同 S3 数据源实例的自定义名称",
        },
        {
            "name": "endpoint",
            "label": "服务地址",
            ...
            "required": True,
            "default": "",
            "placeholder": "请输入 S3 Endpoint，例如 10.0.86.244:9000",
            "secret": False,
            "options": [],
            "description": "S3 兼容对象存储服务地址",
        },
        {
            "name": "access_key",
            "label": "Access Key",
            ...
            "secret": False,
            "options": [],
            "description": "用于访问 S3 兼容对象存储的 Access Key",
        },
        {
            "name": "secret_key",
            "label": "Secret Key",
            ...
            "secret": True,
            "options": [],
            "description": "用于访问 S3 兼容对象存储的 Secret Key",
        },
        {
            "name": "secure",
            "label": "启用 HTTPS",
            ...
            "secret": False,
            "options": [],
            "description": "是否通过 HTTPS 连接对象存储服务",
        },
        {
            "name": "bucket",
            "label": "Bucket",
            ...
            "secret": False,
            "options": [],
            "description": "S3 对象存储中的 Bucket 名称",
        },
        {
            "name": "base_prefix",
            "label": "基础目录",
            "type": "string",
            "required": True,
            "default": "corpus/output/piflow",
            "placeholder": "请输入对象存储基础目录前缀",
            "secret": False,
            "options": [],
            "description": "对象键的基础目录前缀，后续浏览和下载路径均相对于该前缀",
        },
        {
            "name": "logo",
            "label": "Logo",
            ...
            "required": False,
            "default": "",
            "placeholder": "可选，支持 Base64 Logo 字符串",
            "secret": False,
            "options": [],
            "description": "可选的 Base64 Logo 字符串",
        },
    ]
    capabilities = ["list", "download"]
    extra_meta = {
        "builtin": True,
        "instance_api_prefix": "/s3/source",
        "supports_validation": True,
    }
    ...
    cursor.execute(
        ...
        (
            ...
            "S3",
            "file",
            "S3 兼容对象存储类型，用于访问 Bucket 目录并进行文件浏览与下载。",
            S3_TYPE_LOGO,
            True,
            2,
            Json(capabilities),
