...
def run_clean_ip_mapper(input_path: str, output_path: str, repl: str = ""):
    """
    Clean IP Mapper - 清除文本中的IPv4和IPv6地址

    参照测试代码 test_clean_ip_mapper.py 中的 _run_clean_ip 函数实现：
    1. 初始化算子（可指定 repl 参数）
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Clean IP Mapper - 清除IP地址")
    parser.add_argument(
    ...
    run_clean_ip_mapper(args.input_path, args.output_path, args.repl)
