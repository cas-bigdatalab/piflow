...
def run_clean_email_mapper(input_path: str, output_path: str, repl: str = ""):
    """
    Clean Email Mapper - 清理文本中的电子邮件地址

    参照测试代码 test_clean_email_mapper.py 中的 _run_clean_email 函数实现：
    1. 初始化算子（可指定 repl 参数）
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Clean Email Mapper - 清理电子邮件")
    parser.add_argument(
    ...
    run_clean_email_mapper(args.input_path, args.output_path, args.repl)
