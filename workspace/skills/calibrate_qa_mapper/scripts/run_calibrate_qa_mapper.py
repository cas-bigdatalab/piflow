...
def run_calibrate_qa_mapper(
    ...
    """
    Calibrate QA Mapper - 基于参考文本校准问答对

    参照测试代码 test_calibrate_qa_mapper.py 中的 _run_op 函数实现：
    ...
    op = CalibrateQAMapper(**op_params)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Calibrate QA Mapper - 基于参考文本校准问答对"
    )
    parser.add_argument(
    ...
    parser.add_argument("--api_endpoint", type=str, default=None, help="API端点URL")
    parser.add_argument("--response_path", type=str, default=None, help="响应内容路径")
    parser.add_argument("--text_key", type=str, default="text", help="参考文本字段名")
    parser.add_argument("--query_key", type=str, default="query", help="问题字段名")
    parser.add_argument(
        "--response_key", type=str, default="response", help="回答字段名"
    )
