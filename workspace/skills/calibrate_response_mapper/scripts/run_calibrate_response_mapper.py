...
def run_calibrate_response_mapper(
    input_path: str,
    output_path: str,
    api_model: str,
    ...
    """
    Calibrate Response Mapper - 基于参考文本校准问答对中的响应

    参照测试代码 test_calibrate_response_mapper.py 中的 _run_op 函数实现：
    ...
    op = CalibrateResponseMapper(**op_params)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Calibrate Response Mapper - 基于参考文本校准问答对中的响应"
    )
    parser.add_argument(
