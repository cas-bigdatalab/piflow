...
def run_watermark_filter(input_path: str, output_path: str,
    ...
    :param hf_watermark_model: 水印检测模型名称
    :param prob_threshold: 水印概率阈值
...
def main():
    ...
    run_watermark_filter(
        input_path=args.input_path,
        output_path=args.output_path,
        hf_watermark_model=args.hf_watermark_model,
