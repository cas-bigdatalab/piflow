...
export function ThreadsSidebar() {
  ...
  return (
   <aside
  className={`relative z-20 flex h-screen flex-shrink-0 flex-col border-r border-slate-200/80 bg-[#f7f7f9] backdrop-blur transition-all duration-300 ${isShow ? 'w-[280px]' : 'w-[60px]'}`}
>
  {isSending && (
    ...
    {isShow ? (
      <>
        <div className="px-4 pb-3">
          <button
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-white px-4 py-3 text-sm font-semibold text-black transition-colors hover:bg-[#eaedf9] hover:text-[#0112ff]"
            onClick={() => {
