...
useEffect(() => {
  ...
  const loadMySkills = () => {
    // 这里可以未来替换为真实 API，现在用 mock
    setDisplayGroups(MY_SKILLS_MOCK);
    setLoading(false);
  };
  ...
  // 示例：静态的“我的空间”算子数据
const MY_SKILLS_MOCK: SkillGroup[] = [
  {
    groupName: "我的常用算子",
    DagSkillInfoList: [
      {
        skill_name: "alphanumeric_filter",
        name_zh: "字母数字比例过滤器算子",
        description: "字母数字比例过滤器。过滤文本中字母/数字比例不在指定范围内的样本。",
        skill_type: "数据筛选",
        version: "1.0.0",
        icon_path: "/storage/skills/alphanumeric_filter.png",
        publisher: "ME",
        skill_id: "mock-1",
        file_path: "skills/alphanumeric_filter/scripts/run_alphanumeric_filter.py",
        language: "Python",
        input_params: { params: [] },
        output_params: { params: [] },
        is_deleted: 0,
        create_time: "2026-07-09T03:07:20.731892",
        update_time: "2026-07-09T03:07:20.731892",
        disciplinary_field: "基础",
        skill_path: "skills/alphanumeric_filter"
      },
      // 可以再加几个 mock 算子
    ]
  }
